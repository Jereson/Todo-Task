...
import 'package:todo_task/view/widgets/custom_loader/custom_loader.dart';
import 'package:todo_task/view/widgets/custom_loader/transition.dart';
import 'package:todo_task/view/widgets/custom_loader/utils.dart';
...
class _ProgressDialogWidget extends StatefulWidget {
  ...
  final double? blur;
  final Color? backgroundColor;
  final _ProgressDialogWidgetState _dialogWidgetState =
      _ProgressDialogWidgetState();
...
class _ProgressDialogWidgetState extends State<_ProgressDialogWidget>
  ...
  Widget build(BuildContext context) {
    ...
    DialogThemeData dialogTheme = Theme.of(context).dialogTheme;

    Widget? title = _title ?? widget.title;
    Widget message = _message ?? (widget.message ?? const SizedBox.shrink());
    Color backgroundColor =
        _backgroundColor ?? (widget.backgroundColor ?? generalBarrierColor);
    Widget loading =
        (_loading ?? widget.loadingWidget) ??
        Container(
    ...
    return NAlertDialog(
      ...
      dialogStyle: widget.dialogStyle?.copyWith(contentPadding: msgPadding),
      content: Column(
            ...
            children: <Widget>[
              ...
              Expanded(
                child: DefaultTextStyle(
                  style:
                      (widget.dialogStyle?.contentTextStyle ??
...
class CustomProgressDialog implements _CustomProgressDialog {
  ...
  // this.contex,
  {
    this.backgroundColor = kcTransparent,
    this.blur,
    this.onCancel,
  ...
  void _initProgress() {
    _progressDialogWidget = _CustomProgressDialogWidget(
      ...
      backgroundColor: backgroundColor,
      onDismiss: onDismiss,
      loadingWidget: CustomLoader(text: loadingText), // loadingWidget,
    );
  }
...
class _CustomProgressDialogWidget extends StatefulWidget {
  ...
  final Color? backgroundColor;
  final bool? dismissable;
  final _CustomProgressDialogWidgetState _dialogWidgetState =
